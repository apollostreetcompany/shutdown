...
export const EN: GuideTranslations = {
  ...
  heroPriceGoesUp: 'GUIDE CHECKOUT',
  heroPriceSubtext: 'One-time guide purchase through secure checkout',
  heroHrs: 'HRS',
  heroMin: 'MIN',
  heroSec: 'SEC',
  specialLaunch: '\u2605 OFFICIAL STATE-SOURCED GUIDE \u2605',
  ...
  urgencyItems: [
    ...
    { label: 'Requirements vary by state \u2014 confirm current forms before filing' },
  ],
  ...
  ctaTodayOnly: 'ONE-TIME',
  relatedTitle: 'ALSO DISSOLVING IN ANOTHER STATE?',
  relatedViewGuide: 'View Guide \u2192',
  footerRights: '\u00A9 2026 Shutdown Assistant. All rights reserved.',
  footerTerms: 'Terms',
...
export const ES: GuideTranslations = {
  ...
  heroBoughtToday: 'PRECIO DE LA GU\u00CDA:',
  ...
  heroPriceGoesUp: 'PAGO DE LA GU\u00CDA',
  heroPriceSubtext: 'Compra \u00FAnica de la gu\u00EDa mediante pago seguro',
  heroHrs: 'HRS',
  heroMin: 'MIN',
  heroSec: 'SEG',
  specialLaunch: '\u2605 GU\u00CDA BASADA EN FUENTES OFICIALES \u2605',
  ...
  urgencyItems: [
    ...
    { label: 'Los requisitos var\u00EDan por estado \u2014 confirma los formularios vigentes antes de presentar' },
  ],
  ...
  ctaBuyButton: 'OBTENER LA GU\u00CDA \u2014 $49',
  ...
  footerRights: '\u00A9 2026 Shutdown Assistant. Todos los derechos reservados.',

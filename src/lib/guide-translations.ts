...
export const ES: GuideTranslations = {
  ...
  heroPreBadge: 'Para Emprendedores Disolviendo un Negocio en',
  ...
  guideContentsSubtitle: '10 cap\u00EDtulos. Sin relleno. Cada paso en orden.',
  ...
  costSubtitleTemplate: 'Cada tarifa, obligaci\u00F3n fiscal y costo oculto de cerrar en {state}',
  ...
  urgencyItems: [
    { label: 'Un negocio promedio acumula $4,200+ en pasivos no detectados antes del cierre' },
    { label: '23 estados han aumentado las tarifas de disoluci\u00F3n y el rigor de las auditor\u00EDas desde 2023' },
  ...
  ctaGuaranteeText: 'Lee la gu\u00EDa completa. Si no la encuentras valiosa, env\u00EDanos un correo y te devolvemos cada centavo. Sin preguntas. Sin formularios. Sin esperas.',
  ctaBuyButton: 'COMPRAR \u2014 SOLO $29',
  ctaSecure: 'PAGO SEGURO',
  ctaInstant: 'ENTREGA INMEDIATA',
  ctaGuarantee: 'GARANT\u00CDA 30 D\u00CDAS',
  ctaDisclaimer: 'Pago \u00FAnico. Descarga instant\u00E1nea en PDF. Sin suscripciones.',
  ...
  footerDisclaimerTemplate: 'Esta gu\u00EDa es solo para fines informativos y no constituye asesoramiento legal. La informaci\u00F3n proviene de sitios web oficiales del estado, incluyendo la {agency}. Siempre confirma los requisitos actuales directamente. Consulta a un abogado para asesoramiento sobre tu situaci\u00F3n espec\u00EDfica.',
  mobileWas: 'ERA $49',
  mobileOneTime: '\u00DANICO',
  mobileSecure: 'SEGURO',
  mobileCheckout: 'PAGO',
  seoTitleTemplate: 'C\u00F3mo Cerrar un Negocio en {state} \u2014 Gu\u00EDa Completa de Disoluci\u00F3n',
  seoDescriptionTemplate: 'Gu\u00EDa paso a paso para disolver tu LLC o corporaci\u00F3n en {state}. Cada formulario, tarifa y plazo de la {agency}. Liquidaci\u00F3n fiscal, notificaci\u00F3n a acreedores y lista de verificaci\u00F3n post-disoluci\u00F3n.',
